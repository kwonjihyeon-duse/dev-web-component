...
const useColorCodes = ['red', 'orange', 'brown', 'yellow', 'green', 'mintgreen', 'blue', 'indigo', 'purple', 'bluegray', 'gray'];
const useThemeCodes = ['primary', 'secondary', 'text', 'background', 'bg', 'divider', 'icon', 'other', 'state', 'state-container', 'transparent'];
